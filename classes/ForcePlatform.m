classdef ForcePlatform
    ...
    methods
        function obj=ForcePlatform(varargin)
        ...
        %SPLIT Splits the forceplates in groups based on existing events
        ...
        %   containing Foot_Strike and Foot_Off events)
            ...
            if k
                ...
                warning("Force plate splitting unsuccessful");
            end
        end
        %% GRAPHICS
